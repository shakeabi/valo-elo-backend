      ...
      try {
        ...
        await new Promise((resolve) => {
          ...
          for(let mStack in data.Matches) {
           ...
           if(m.MatchID) {
             parsed.push({ "MatchID":m.MatchID, "MatchStartTime":date, "TierAfterUpdate":m.TierAfterUpdate, "TierBeforeUpdate":m.TierBeforeUpdate, "CompetitiveMovement":m.CompetitiveMovement, "RankedRatingBeforeUpdate": m.RankedRatingBeforeUpdate, "RankedRatingAfterUpdate": m.RankedRatingAfterUpdate });
             length--;
           }
